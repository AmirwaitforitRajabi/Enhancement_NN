...
result_path = pathlib.Path(
    f'F:/Projekts/cruse/06_my_model_{batch_size}_mse_2__{learning_rate}_skip_add')
startAll = time.time()
...
R0 = tf.compat.v1.keras.layers.CuDNNLSTM(1024, return_sequences=True)(Re_shape)

R3 = tf.compat.v1.keras.layers.CuDNNLSTM(1024, return_sequences=True)(R0)

Re_Reshape = tf.keras.layers.Reshape((200, 4, 256))(R3)

Skip1 = Add()([c5_b_skip, Re_Reshape])
